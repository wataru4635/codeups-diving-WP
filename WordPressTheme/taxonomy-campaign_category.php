...
<section class="sub-mv">
  ...
  <div class="sub-mv__img">
    <picture>
      <source media="(max-width: 767px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/page-campaign-mv_sp.jpg"
        type="image/jpeg" />
      <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/page-campaign-mv_pc.jpg"
        type="image/jpeg" />
      <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/page-campaign-mv_sp.jpg" alt="ゴールデンバタフライフィッシュが泳いでいる様子" />
    </picture>
  </div>
</section>
...
?>
    ...
    <div class="page-campaign__tab common-tab">
      <ul class="common-tab__lists">
        <li class="common-tab__list <?php echo $cat_name === 'ALL' ? 'is-active' : ''; ?>"><a  href="<?php echo get_post_type_archive_link('campaign') ?>">ALL</a></li>
        <?php $course_terms = get_terms('campaign_category', array('hide_empty'=>false)); ?>
        <?php foreach($course_terms as $course_term ) : ?>
        <li class="common-tab__list <?php echo $cat_name === $course_term->name ? 'is-active' : ''; ?>"><a href="<?php echo get_term_link($course_term,'campaign_category'); ?>"><?php echo $course_term->name; ?></a></li>
        <?php endforeach; ?>
      </ul>
    </div>
