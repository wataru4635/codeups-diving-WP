        ...
        <div class="sub-mv__img">
            <picture>
                <source media="(max-width: 767px)"
                        srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/page-campaign-mv_sp.jpg"
                        type="image/jpeg" />
                <source media="(min-width: 768px)"
                        srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/page-campaign-mv_pc.jpg"
                        type="image/jpeg" />
            ...
            <div class="page-campaign__tab common-tab">
                <ul class="common-tab__lists">
                    <li class="common-tab__list <?php echo $cat_name === 'ALL' ? 'is-active' : ''; ?>"><a
                                href="<?php echo get_post_type_archive_link('campaign') ?>">ALL</a></li>
