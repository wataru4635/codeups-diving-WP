    ...
    <div class="sideContent__wrapper">
      ...
      <div class="sideContent__item sidebar-voice-item">
        ...
        <?php $voiceMeta = get_field('voice_meta');?>
          <p class="sidebar-voice-item__meta"><?php echo $voiceMeta['meta_1']; ?>代(<?php echo $voiceMeta['meta_2']; ?>)</p>
          <h3 class="sidebar-voice-item__title">
          <?php the_title(); // タイトルを表示 ?>          </h3>
        </div>
      </div>
      <?php
              endwhile;
        ...
        <div class="sidebar-accordion__list">
          ...
          <ul class="sidebar-accordion__items">
            ...
            <li class="sidebar-accordion__item">
              <a
                href="<?php echo esc_url(home_url()); ?>/<?php echo $month->year; ?>/<?php echo date("m", mktime(0, 0, 0, $month->month, 1, $month->year)) ?>">
