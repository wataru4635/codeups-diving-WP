        ...
        <div class="mv__loading loading-mv">
          ...
          <div class="loading-mv__img">
            <div class="loading-mv__img-left">
              <picture>
                <source media="(max-width: 767px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/loading-left_sp.jpg"
                  type="image/jpeg" />
                <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/loading-left_pc.jpg"
                  type="image/jpeg" />
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/loading-left_sp.jpg" alt="ウミガメが海の中から空を見ている様子の左半分の画像" />
              </picture>
            </div>
            <div class="loading-mv__img-right">
              <picture>
                <source media="(max-width: 767px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/loading-right_sp.jpg"
                  type="image/jpeg" />
                <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/loading-right_pc.jpg"
                  type="image/jpeg" />
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/loading-right_sp.jpg" alt="ウミガメが海の中から空を見ている様子の右半分の画像" />
              </picture>
            </div>
          </div>
        </div>
        ...
        <div class="swiper mv__swiper js-mv-swiper">
          <div class="swiper-wrapper mv__wrapper">
            <div class="swiper-slide mv__img">
              <picture>
                <source media="(max-width: 767px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/mv-sp_1.jpg" type="image/jpeg" />
                <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/mv-pc_1.jpg" type="image/jpeg" />
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/mv-sp_1.jpg" alt="ウミガメが海の中から空を見ている様子" />
              </picture>
            </div>
            <div class="swiper-slide mv__img">
              <picture>
                <source media="(max-width: 767px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/mv-sp_2.jpg" type="image/jpeg" />
                <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/mv-pc_2.jpg" type="image/jpeg" />
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/mv-sp_2.jpg" alt="ウミガメが泳いでいる様子" />
              </picture>
            </div>
            <div class="swiper-slide mv__img">
              <picture>
                <source media="(max-width: 767px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/mv-sp_3.jpg" type="image/jpeg" />
                <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/mv-pc_3.jpg" type="image/jpeg" />
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/mv-sp_3.jpg" alt="海の上に船が進んでいる様子" />
              </picture>
            </div>
            <div class="swiper-slide mv__img">
              <picture>
                <source media="(max-width: 767px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/mv-sp_4.jpg" type="image/jpeg" />
                <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/mv-pc_4.jpg" type="image/jpeg" />
        ...
        <div class="swiper campaign__swiper js-campaign-swiper">
          <div class="swiper-wrapper campaign__cards">
            <div class="swiper-slide campaign__card">
              <div class="campaign-card">
                <div class="campaign-card__img">
                  <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/campaign-sp_1.jpg" alt="色とりどりのたくさんの魚が泳いでいる様子" />
                </div>
            ...
            <div class="swiper-slide campaign__card">
              <div class="campaign-card">
                <div class="campaign-card__img">
                  <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/campaign-sp_2.jpg" alt="エメラルドグリーンの綺麗な海の様子" />
                </div>
                <div class="campaign-card__inner">
                  <div class="campaign-card__head">
            ...
            <div class="swiper-slide campaign__card">
              <div class="campaign-card">
                <div class="campaign-card__img">
                  <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/campaign-sp_3.jpg" alt="スカイブルーに光る小さいクラゲが泳いでいる様子" />
                </div>
                <div class="campaign-card__inner">
                  <div class="campaign-card__head">
                    <p class="campaign-card__label">体験ダイビング</p>
            ...
            <div class="swiper-slide campaign__card">
              <div class="campaign-card">
                <div class="campaign-card__img">
                  <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/campaign-sp_4.jpg" alt="ファンダイビングをしている様子" />
                </div>
                <div class="campaign-card__inner">
                  <div class="campaign-card__head">
        ...
        <div class="about__container">
          <div class="about__images">
            <div class="about__img-left">
              <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/about-left.jpg" alt="屋根の上にシーサーがのっている様子" />
            </div>
            <div class="about__img-right">
              <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/about-right.jpg" alt="ゴールデンバタフライフィッシュが泳いでいる様子" />
            </div>
          </div>
      ...
      <div class="information__inner inner">
        ...
        <div class="information__media information-card">
          <div class="information-card__img js-slide-animation">
            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/information.jpg" alt="ゴールデンバタフライフィッシュが中心にたくさんの魚が泳いでいる様子" />
          </div>
      ...
      <div class="price__inner inner">
        ...
        <div class="price__container">
          <div class="price__img js-slide-animation">
            <picture>
              <source media="(max-width: 767px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/price-sp.jpg" type="image/jpeg" />
              <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/price-pc.jpg" type="image/jpeg" />
    ...
    <?php foreach ($plans as $plan) : ?>
            <li class="price__list">
              ...
              <?php
                ...
                ?>
                <dt class="price__text"><?php echo $item[$plan['course_key'][0]]; ?><?php echo $item[$plan['course_key'][1]]; ?></dt>
